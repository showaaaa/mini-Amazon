...
SECRET_KEY = 'django-insecure-02x5zc+@$16qh#w)q-@tnazs#e4d0=%*efr=k#l7m5f=7)cr4m'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['web', 'vcm-32291.vm.duke.edu','127.0.0.1']
...
DATABASES = {
    'default': {
        ...
        'NAME': 'comment',         # 数据库名，Django不会帮你创建，需要自己进入数据库创建。
