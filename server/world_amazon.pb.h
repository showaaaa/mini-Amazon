...
extern AItemDefaultTypeInternal _AItem_default_instance_;
class ALoaded;
...
extern ASendTruckDefaultTypeInternal _ASendTruck_default_instance_;
class ATruckLoaded;
struct ATruckLoadedDefaultTypeInternal;
extern ATruckLoadedDefaultTypeInternal _ATruckLoaded_default_instance_;
class AzConnected;
struct AzConnectedDefaultTypeInternal;
extern AzConnectedDefaultTypeInternal _AzConnected_default_instance_;
class UMessage;
struct UMessageDefaultTypeInternal;
extern UMessageDefaultTypeInternal _UMessage_default_instance_;
class UPackageDelivered;
struct UPackageDeliveredDefaultTypeInternal;
extern UPackageDeliveredDefaultTypeInternal _UPackageDelivered_default_instance_;
class UTruckAtWH;
struct UTruckAtWHDefaultTypeInternal;
extern UTruckAtWHDefaultTypeInternal _UTruckAtWH_default_instance_;
class UtoAzConnect;
struct UtoAzConnectDefaultTypeInternal;
extern UtoAzConnectDefaultTypeInternal _UtoAzConnect_default_instance_;
PROTOBUF_NAMESPACE_OPEN
...
template<> ::AItem* Arena::CreateMaybeMessage<::AItem>(Arena*);
...
template<> ::ASendTruck* Arena::CreateMaybeMessage<::ASendTruck>(Arena*);
template<> ::ATruckLoaded* Arena::CreateMaybeMessage<::ATruckLoaded>(Arena*);
template<> ::AzConnected* Arena::CreateMaybeMessage<::AzConnected>(Arena*);
template<> ::UMessage* Arena::CreateMaybeMessage<::UMessage>(Arena*);
template<> ::UPackageDelivered* Arena::CreateMaybeMessage<::UPackageDelivered>(Arena*);
template<> ::UTruckAtWH* Arena::CreateMaybeMessage<::UTruckAtWH>(Arena*);
template<> ::UtoAzConnect* Arena::CreateMaybeMessage<::UtoAzConnect>(Arena*);
PROTOBUF_NAMESPACE_CLOSE

// ===================================================================

class UtoAzConnect final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:UtoAzConnect) */ {
 public:
  inline UtoAzConnect() : UtoAzConnect(nullptr) {}
  ~UtoAzConnect() override;
  explicit PROTOBUF_CONSTEXPR UtoAzConnect(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  UtoAzConnect(const UtoAzConnect& from);
  UtoAzConnect(UtoAzConnect&& from) noexcept
    : UtoAzConnect() {
    *this = ::std::move(from);
  }

  inline UtoAzConnect& operator=(const UtoAzConnect& from) {
    CopyFrom(from);
    return *this;
  }
  inline UtoAzConnect& operator=(UtoAzConnect&& from) noexcept {
  ...
  static const UtoAzConnect& default_instance() {
    return *internal_default_instance();
  }
  static inline const UtoAzConnect* internal_default_instance() {
    return reinterpret_cast<const UtoAzConnect*>(
               &_UtoAzConnect_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    0;

  friend void swap(UtoAzConnect& a, UtoAzConnect& b) {
    a.Swap(&b);
  }
  inline void Swap(UtoAzConnect* other) {
  ...
  void UnsafeArenaSwap(UtoAzConnect* other) {
    if (other == this) return;
  ...
  UtoAzConnect* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<UtoAzConnect>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const UtoAzConnect& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom(const UtoAzConnect& from);
  private:
  ...
  void InternalSwap(UtoAzConnect* other);
  ...
  protected:
  explicit UtoAzConnect(::PROTOBUF_NAMESPACE_ID::Arena* arena,
...
class AzConnected final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:AzConnected) */ {
 public:
  inline AzConnected() : AzConnected(nullptr) {}
  ~AzConnected() override;
  explicit PROTOBUF_CONSTEXPR AzConnected(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  AzConnected(const AzConnected& from);
  AzConnected(AzConnected&& from) noexcept
    : AzConnected() {
    *this = ::std::move(from);
  }

  inline AzConnected& operator=(const AzConnected& from) {
    CopyFrom(from);
    return *this;
  }
  inline AzConnected& operator=(AzConnected&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const AzConnected& default_instance() {
    return *internal_default_instance();
  }
  static inline const AzConnected* internal_default_instance() {
    return reinterpret_cast<const AzConnected*>(
               &_AzConnected_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    1;

  friend void swap(AzConnected& a, AzConnected& b) {
    a.Swap(&b);
  }
  inline void Swap(AzConnected* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(AzConnected* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  AzConnected* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<AzConnected>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const AzConnected& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom(const AzConnected& from);
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to, const ::PROTOBUF_NAMESPACE_ID::Message& from);
  public:
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(AzConnected* other);
  ...
  protected:
  explicit AzConnected(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
...
class AItem final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:AItem) */ {
 public:
  inline AItem() : AItem(nullptr) {}
  ~AItem() override;
  explicit PROTOBUF_CONSTEXPR AItem(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  AItem(const AItem& from);
  AItem(AItem&& from) noexcept
    : AItem() {
    *this = ::std::move(from);
  }

  inline AItem& operator=(const AItem& from) {
    CopyFrom(from);
    return *this;
  }
  inline AItem& operator=(AItem&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const AItem& default_instance() {
    return *internal_default_instance();
  }
  static inline const AItem* internal_default_instance() {
    return reinterpret_cast<const AItem*>(
               &_AItem_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    2;

  friend void swap(AItem& a, AItem& b) {
    a.Swap(&b);
  }
  inline void Swap(AItem* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(AItem* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  AItem* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<AItem>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const AItem& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom(const AItem& from);
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to, const ::PROTOBUF_NAMESPACE_ID::Message& from);
  public:
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  ...
  protected:
  explicit AItem(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
...
class ASendTruck final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:ASendTruck) */ {
 public:
  inline ASendTruck() : ASendTruck(nullptr) {}
  ~ASendTruck() override;
  explicit PROTOBUF_CONSTEXPR ASendTruck(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  ASendTruck(const ASendTruck& from);
  ASendTruck(ASendTruck&& from) noexcept
    : ASendTruck() {
    *this = ::std::move(from);
  }

  inline ASendTruck& operator=(const ASendTruck& from) {
    CopyFrom(from);
    return *this;
  }
  inline ASendTruck& operator=(ASendTruck&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const ASendTruck& default_instance() {
    return *internal_default_instance();
  }
  static inline const ASendTruck* internal_default_instance() {
    return reinterpret_cast<const ASendTruck*>(
               &_ASendTruck_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    3;

  friend void swap(ASendTruck& a, ASendTruck& b) {
    a.Swap(&b);
  }
  inline void Swap(ASendTruck* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(ASendTruck* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  ASendTruck* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<ASendTruck>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const ASendTruck& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom(const ASendTruck& from);
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to, const ::PROTOBUF_NAMESPACE_ID::Message& from);
  public:
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(ASendTruck* other);
  ...
  protected:
  explicit ASendTruck(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  public:
  void clear_items();
  ::AItem* mutable_items(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::AItem >*
      mutable_items();
  private:
  const ::AItem& _internal_items(int index) const;
  ::AItem* _internal_add_items();
  public:
  const ::AItem& items(int index) const;
  ::AItem* add_items();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::AItem >&
      items() const;
  ...
  int64_t package_id() const;
  void set_package_id(int64_t value);
  private:
  int64_t _internal_package_id() const;
  void _internal_set_package_id(int64_t value);
  public:

  // required int64 warehouse_id = 2;
  bool has_warehouse_id() const;
  private:
  bool _internal_has_warehouse_id() const;
  public:
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::HasBits<1> _has_bits_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::AItem > items_;
  int64_t package_id_;
...
class UTruckAtWH final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:UTruckAtWH) */ {
 public:
  inline UTruckAtWH() : UTruckAtWH(nullptr) {}
  ~UTruckAtWH() override;
  explicit PROTOBUF_CONSTEXPR UTruckAtWH(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  UTruckAtWH(const UTruckAtWH& from);
  UTruckAtWH(UTruckAtWH&& from) noexcept
    : UTruckAtWH() {
    *this = ::std::move(from);
  }

  inline UTruckAtWH& operator=(const UTruckAtWH& from) {
    CopyFrom(from);
    return *this;
  }
  inline UTruckAtWH& operator=(UTruckAtWH&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const UTruckAtWH& default_instance() {
    return *internal_default_instance();
  }
  static inline const UTruckAtWH* internal_default_instance() {
    return reinterpret_cast<const UTruckAtWH*>(
               &_UTruckAtWH_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    4;

  friend void swap(UTruckAtWH& a, UTruckAtWH& b) {
    a.Swap(&b);
  }
  inline void Swap(UTruckAtWH* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(UTruckAtWH* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  UTruckAtWH* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<UTruckAtWH>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const UTruckAtWH& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom(const UTruckAtWH& from);
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to, const ::PROTOBUF_NAMESPACE_ID::Message& from);
  public:
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(UTruckAtWH* other);
  ...
  protected:
  explicit UTruckAtWH(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  private:
  bool _internal_has_truck_id() const;
  public:
  void clear_truck_id();
  int64_t truck_id() const;
  void set_truck_id(int64_t value);
  private:
  int64_t _internal_truck_id() const;
  void _internal_set_truck_id(int64_t value);
  public:
...
class ATruckLoaded final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:ATruckLoaded) */ {
 public:
  inline ATruckLoaded() : ATruckLoaded(nullptr) {}
  ~ATruckLoaded() override;
  explicit PROTOBUF_CONSTEXPR ATruckLoaded(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  ATruckLoaded(const ATruckLoaded& from);
  ATruckLoaded(ATruckLoaded&& from) noexcept
    : ATruckLoaded() {
    *this = ::std::move(from);
  }

  inline ATruckLoaded& operator=(const ATruckLoaded& from) {
    CopyFrom(from);
    return *this;
  }
  inline ATruckLoaded& operator=(ATruckLoaded&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const ATruckLoaded& default_instance() {
    return *internal_default_instance();
  }
  static inline const ATruckLoaded* internal_default_instance() {
    return reinterpret_cast<const ATruckLoaded*>(
               &_ATruckLoaded_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    5;

  friend void swap(ATruckLoaded& a, ATruckLoaded& b) {
    a.Swap(&b);
  }
  inline void Swap(ATruckLoaded* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(ATruckLoaded* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  ATruckLoaded* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<ATruckLoaded>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const ATruckLoaded& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom(const ATruckLoaded& from);
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to, const ::PROTOBUF_NAMESPACE_ID::Message& from);
  public:
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(ATruckLoaded* other);
  ...
  protected:
  explicit ATruckLoaded(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
...
class UPackageDelivered final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:UPackageDelivered) */ {
 public:
  inline UPackageDelivered() : UPackageDelivered(nullptr) {}
  ~UPackageDelivered() override;
  explicit PROTOBUF_CONSTEXPR UPackageDelivered(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  UPackageDelivered(const UPackageDelivered& from);
  UPackageDelivered(UPackageDelivered&& from) noexcept
    : UPackageDelivered() {
    *this = ::std::move(from);
  }

  inline UPackageDelivered& operator=(const UPackageDelivered& from) {
    CopyFrom(from);
    return *this;
  }
  inline UPackageDelivered& operator=(UPackageDelivered&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const UPackageDelivered& default_instance() {
    return *internal_default_instance();
  }
  static inline const UPackageDelivered* internal_default_instance() {
    return reinterpret_cast<const UPackageDelivered*>(
               &_UPackageDelivered_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    6;

  friend void swap(UPackageDelivered& a, UPackageDelivered& b) {
    a.Swap(&b);
  }
  inline void Swap(UPackageDelivered* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(UPackageDelivered* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  UPackageDelivered* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<UPackageDelivered>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const UPackageDelivered& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom(const UPackageDelivered& from);
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to, const ::PROTOBUF_NAMESPACE_ID::Message& from);
  public:
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(UPackageDelivered* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "UPackageDelivered";
  }
  protected:
  explicit UPackageDelivered(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
...
class UMessage final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:UMessage) */ {
 public:
  ...
  enum : int {
    kTruckAtWHFieldNumber = 1,
    kPackageDeliveredFieldNumber = 2,
  };
  // optional .UTruckAtWH truckAtWH = 1;
  bool has_truckatwh() const;
  private:
  bool _internal_has_truckatwh() const;
  public:
  void clear_truckatwh();
  const ::UTruckAtWH& truckatwh() const;
  PROTOBUF_NODISCARD ::UTruckAtWH* release_truckatwh();
  ::UTruckAtWH* mutable_truckatwh();
  void set_allocated_truckatwh(::UTruckAtWH* truckatwh);
  private:
  const ::UTruckAtWH& _internal_truckatwh() const;
  ::UTruckAtWH* _internal_mutable_truckatwh();
  public:
  void unsafe_arena_set_allocated_truckatwh(
      ::UTruckAtWH* truckatwh);
  ::UTruckAtWH* unsafe_arena_release_truckatwh();

  // optional .UPackageDelivered packageDelivered = 2;
  bool has_packagedelivered() const;
  private:
  bool _internal_has_packagedelivered() const;
  public:
  void clear_packagedelivered();
  const ::UPackageDelivered& packagedelivered() const;
  PROTOBUF_NODISCARD ::UPackageDelivered* release_packagedelivered();
  ::UPackageDelivered* mutable_packagedelivered();
  void set_allocated_packagedelivered(::UPackageDelivered* packagedelivered);
  private:
  const ::UPackageDelivered& _internal_packagedelivered() const;
  ::UPackageDelivered* _internal_mutable_packagedelivered();
  public:
  void unsafe_arena_set_allocated_packagedelivered(
      ::UPackageDelivered* packagedelivered);
  ::UPackageDelivered* unsafe_arena_release_packagedelivered();
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::HasBits<1> _has_bits_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  ::UTruckAtWH* truckatwh_;
  ::UPackageDelivered* packagedelivered_;
  friend struct ::TableStruct_world_5famazon_2eproto;
};
// -------------------------------------------------------------------
...
class AMessage final :
 ...
 public:
  ...
  enum : int {
    kSendTruckFieldNumber = 1,
    kTruckLoadedFieldNumber = 2,
  };
  // optional .ASendTruck sendTruck = 1;
  bool has_sendtruck() const;
  private:
  bool _internal_has_sendtruck() const;
  public:
  void clear_sendtruck();
  const ::ASendTruck& sendtruck() const;
  PROTOBUF_NODISCARD ::ASendTruck* release_sendtruck();
  ::ASendTruck* mutable_sendtruck();
  void set_allocated_sendtruck(::ASendTruck* sendtruck);
  private:
  const ::ASendTruck& _internal_sendtruck() const;
  ::ASendTruck* _internal_mutable_sendtruck();
  public:
  void unsafe_arena_set_allocated_sendtruck(
      ::ASendTruck* sendtruck);
  ::ASendTruck* unsafe_arena_release_sendtruck();

  // optional .ATruckLoaded truckLoaded = 2;
  bool has_truckloaded() const;
  private:
  bool _internal_has_truckloaded() const;
  public:
  void clear_truckloaded();
  const ::ATruckLoaded& truckloaded() const;
  PROTOBUF_NODISCARD ::ATruckLoaded* release_truckloaded();
  ::ATruckLoaded* mutable_truckloaded();
  void set_allocated_truckloaded(::ATruckLoaded* truckloaded);
  private:
  const ::ATruckLoaded& _internal_truckloaded() const;
  ::ATruckLoaded* _internal_mutable_truckloaded();
  public:
  void unsafe_arena_set_allocated_truckloaded(
      ::ATruckLoaded* truckloaded);
  ::ATruckLoaded* unsafe_arena_release_truckloaded();
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::HasBits<1> _has_bits_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  ::ASendTruck* sendtruck_;
  ::ATruckLoaded* truckloaded_;
  friend struct ::TableStruct_world_5famazon_2eproto;
};
// -------------------------------------------------------------------
...
// required int64 worldid = 1;
inline bool UtoAzConnect::_internal_has_worldid() const {
  bool value = (_has_bits_[0] & 0x00000001u) != 0;
  return value;
}
inline bool UtoAzConnect::has_worldid() const {
  return _internal_has_worldid();
}
inline void UtoAzConnect::clear_worldid() {
  worldid_ = int64_t{0};
  _has_bits_[0] &= ~0x00000001u;
}
inline int64_t UtoAzConnect::_internal_worldid() const {
  return worldid_;
}
inline int64_t UtoAzConnect::worldid() const {
  // @@protoc_insertion_point(field_get:UtoAzConnect.worldid)
  return _internal_worldid();
}
inline void UtoAzConnect::_internal_set_worldid(int64_t value) {
  _has_bits_[0] |= 0x00000001u;
  worldid_ = value;
}
inline void UtoAzConnect::set_worldid(int64_t value) {
  _internal_set_worldid(value);
  // @@protoc_insertion_point(field_set:UtoAzConnect.worldid)
}
...
// required int64 worldid = 1;
inline bool AzConnected::_internal_has_worldid() const {
  bool value = (_has_bits_[0] & 0x00000002u) != 0;
  return value;
}
inline bool AzConnected::has_worldid() const {
  return _internal_has_worldid();
}
inline void AzConnected::clear_worldid() {
  worldid_ = int64_t{0};
  _has_bits_[0] &= ~0x00000002u;
}
inline int64_t AzConnected::_internal_worldid() const {
  return worldid_;
}
inline int64_t AzConnected::worldid() const {
  // @@protoc_insertion_point(field_get:AzConnected.worldid)
  return _internal_worldid();
}
inline void AzConnected::_internal_set_worldid(int64_t value) {
  _has_bits_[0] |= 0x00000002u;
  worldid_ = value;
}
inline void AzConnected::set_worldid(int64_t value) {
  _internal_set_worldid(value);
  // @@protoc_insertion_point(field_set:AzConnected.worldid)
}

// required string result = 2;
inline bool AzConnected::_internal_has_result() const {
  bool value = (_has_bits_[0] & 0x00000001u) != 0;
  return value;
}
inline bool AzConnected::has_result() const {
  return _internal_has_result();
}
inline void AzConnected::clear_result() {
  result_.ClearToEmpty();
  _has_bits_[0] &= ~0x00000001u;
}
inline const std::string& AzConnected::result() const {
  // @@protoc_insertion_point(field_get:AzConnected.result)
  return _internal_result();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void AzConnected::set_result(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000001u;
 result_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:AzConnected.result)
}
inline std::string* AzConnected::mutable_result() {
  std::string* _s = _internal_mutable_result();
  // @@protoc_insertion_point(field_mutable:AzConnected.result)
  return _s;
}
inline const std::string& AzConnected::_internal_result() const {
  return result_.Get();
}
inline void AzConnected::_internal_set_result(const std::string& value) {
  _has_bits_[0] |= 0x00000001u;
  result_.Set(value, GetArenaForAllocation());
}
inline std::string* AzConnected::_internal_mutable_result() {
  _has_bits_[0] |= 0x00000001u;
  return result_.Mutable(GetArenaForAllocation());
}
inline std::string* AzConnected::release_result() {
  // @@protoc_insertion_point(field_release:AzConnected.result)
...
inline void AzConnected::set_allocated_result(std::string* result) {
  if (result != nullptr) {
    _has_bits_[0] |= 0x00000001u;
  } else {
    _has_bits_[0] &= ~0x00000001u;
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:AzConnected.result)
}
...
// required string description = 1;
inline bool AItem::_internal_has_description() const {
  bool value = (_has_bits_[0] & 0x00000001u) != 0;
  return value;
}
inline bool AItem::has_description() const {
  return _internal_has_description();
}
inline void AItem::clear_description() {
  description_.ClearToEmpty();
  _has_bits_[0] &= ~0x00000001u;
}
inline const std::string& AItem::description() const {
  // @@protoc_insertion_point(field_get:AItem.description)
  return _internal_description();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void AItem::set_description(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000001u;
 description_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:AItem.description)
}
inline std::string* AItem::mutable_description() {
  std::string* _s = _internal_mutable_description();
  // @@protoc_insertion_point(field_mutable:AItem.description)
  return _s;
}
inline const std::string& AItem::_internal_description() const {
  return description_.Get();
}
inline void AItem::_internal_set_description(const std::string& value) {
  _has_bits_[0] |= 0x00000001u;
  description_.Set(value, GetArenaForAllocation());
}
inline std::string* AItem::_internal_mutable_description() {
  _has_bits_[0] |= 0x00000001u;
  return description_.Mutable(GetArenaForAllocation());
}
inline std::string* AItem::release_description() {
  // @@protoc_insertion_point(field_release:AItem.description)
...
inline void AItem::set_allocated_description(std::string* description) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:AItem.description)
}

// required int64 count = 2;
inline bool AItem::_internal_has_count() const {
  bool value = (_has_bits_[0] & 0x00000002u) != 0;
  return value;
}
inline bool AItem::has_count() const {
  return _internal_has_count();
}
inline void AItem::clear_count() {
  count_ = int64_t{0};
  _has_bits_[0] &= ~0x00000002u;
}
inline int64_t AItem::_internal_count() const {
  return count_;
}
inline int64_t AItem::count() const {
  // @@protoc_insertion_point(field_get:AItem.count)
  return _internal_count();
}
inline void AItem::_internal_set_count(int64_t value) {
  _has_bits_[0] |= 0x00000002u;
  count_ = value;
}
inline void AItem::set_count(int64_t value) {
  _internal_set_count(value);
  // @@protoc_insertion_point(field_set:AItem.count)
}
...
// required int64 package_id = 1;
inline bool ASendTruck::_internal_has_package_id() const {
  bool value = (_has_bits_[0] & 0x00000001u) != 0;
  return value;
}
inline bool ASendTruck::has_package_id() const {
  return _internal_has_package_id();
}
inline void ASendTruck::clear_package_id() {
  package_id_ = int64_t{0};
  _has_bits_[0] &= ~0x00000001u;
}
inline int64_t ASendTruck::_internal_package_id() const {
  return package_id_;
}
inline int64_t ASendTruck::package_id() const {
  // @@protoc_insertion_point(field_get:ASendTruck.package_id)
  return _internal_package_id();
}
inline void ASendTruck::_internal_set_package_id(int64_t value) {
  _has_bits_[0] |= 0x00000001u;
  package_id_ = value;
}
inline void ASendTruck::set_package_id(int64_t value) {
  _internal_set_package_id(value);
  // @@protoc_insertion_point(field_set:ASendTruck.package_id)
}

// required int64 warehouse_id = 2;
inline bool ASendTruck::_internal_has_warehouse_id() const {
  bool value = (_has_bits_[0] & 0x00000002u) != 0;
  return value;
}
inline bool ASendTruck::has_warehouse_id() const {
  return _internal_has_warehouse_id();
}
inline void ASendTruck::clear_warehouse_id() {
  warehouse_id_ = int64_t{0};
  _has_bits_[0] &= ~0x00000002u;
}
inline int64_t ASendTruck::_internal_warehouse_id() const {
  return warehouse_id_;
}
inline int64_t ASendTruck::warehouse_id() const {
  // @@protoc_insertion_point(field_get:ASendTruck.warehouse_id)
  return _internal_warehouse_id();
}
inline void ASendTruck::_internal_set_warehouse_id(int64_t value) {
  _has_bits_[0] |= 0x00000002u;
  warehouse_id_ = value;
}
inline void ASendTruck::set_warehouse_id(int64_t value) {
  _internal_set_warehouse_id(value);
  // @@protoc_insertion_point(field_set:ASendTruck.warehouse_id)
}

// optional int64 user_id = 3;
inline bool ASendTruck::_internal_has_user_id() const {
  bool value = (_has_bits_[0] & 0x00000004u) != 0;
  return value;
}
inline bool ASendTruck::has_user_id() const {
  return _internal_has_user_id();
}
inline void ASendTruck::clear_user_id() {
  user_id_ = int64_t{0};
  _has_bits_[0] &= ~0x00000004u;
}
inline int64_t ASendTruck::_internal_user_id() const {
  return user_id_;
}
inline int64_t ASendTruck::user_id() const {
  // @@protoc_insertion_point(field_get:ASendTruck.user_id)
  return _internal_user_id();
}
inline void ASendTruck::_internal_set_user_id(int64_t value) {
  _has_bits_[0] |= 0x00000004u;
  user_id_ = value;
}
inline void ASendTruck::set_user_id(int64_t value) {
  _internal_set_user_id(value);
  // @@protoc_insertion_point(field_set:ASendTruck.user_id)
}

// required int64 x = 4;
inline bool ASendTruck::_internal_has_x() const {
  bool value = (_has_bits_[0] & 0x00000008u) != 0;
  return value;
}
inline bool ASendTruck::has_x() const {
  return _internal_has_x();
}
inline void ASendTruck::clear_x() {
  x_ = int64_t{0};
  _has_bits_[0] &= ~0x00000008u;
}
inline int64_t ASendTruck::_internal_x() const {
  return x_;
}
inline int64_t ASendTruck::x() const {
  // @@protoc_insertion_point(field_get:ASendTruck.x)
  return _internal_x();
}
inline void ASendTruck::_internal_set_x(int64_t value) {
  _has_bits_[0] |= 0x00000008u;
  x_ = value;
}
inline void ASendTruck::set_x(int64_t value) {
  _internal_set_x(value);
  // @@protoc_insertion_point(field_set:ASendTruck.x)
}

// required int64 y = 5;
inline bool ASendTruck::_internal_has_y() const {
  bool value = (_has_bits_[0] & 0x00000010u) != 0;
  return value;
}
inline bool ASendTruck::has_y() const {
  return _internal_has_y();
}
inline void ASendTruck::clear_y() {
  y_ = int64_t{0};
  _has_bits_[0] &= ~0x00000010u;
}
inline int64_t ASendTruck::_internal_y() const {
  return y_;
}
inline int64_t ASendTruck::y() const {
  // @@protoc_insertion_point(field_get:ASendTruck.y)
  return _internal_y();
}
inline void ASendTruck::_internal_set_y(int64_t value) {
  _has_bits_[0] |= 0x00000010u;
  y_ = value;
}
inline void ASendTruck::set_y(int64_t value) {
  _internal_set_y(value);
  // @@protoc_insertion_point(field_set:ASendTruck.y)
}

// repeated .AItem items = 6;
inline int ASendTruck::_internal_items_size() const {
  return items_.size();
}
inline int ASendTruck::items_size() const {
  return _internal_items_size();
}
inline void ASendTruck::clear_items() {
  items_.Clear();
}
inline ::AItem* ASendTruck::mutable_items(int index) {
  // @@protoc_insertion_point(field_mutable:ASendTruck.items)
  return items_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::AItem >*
ASendTruck::mutable_items() {
  // @@protoc_insertion_point(field_mutable_list:ASendTruck.items)
  return &items_;
}
inline const ::AItem& ASendTruck::_internal_items(int index) const {
  return items_.Get(index);
}
inline const ::AItem& ASendTruck::items(int index) const {
  // @@protoc_insertion_point(field_get:ASendTruck.items)
  return _internal_items(index);
}
inline ::AItem* ASendTruck::_internal_add_items() {
  return items_.Add();
}
inline ::AItem* ASendTruck::add_items() {
  ::AItem* _add = _internal_add_items();
  // @@protoc_insertion_point(field_add:ASendTruck.items)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::AItem >&
ASendTruck::items() const {
  // @@protoc_insertion_point(field_list:ASendTruck.items)
  return items_;
}
...
// required int64 truck_id = 1;
inline bool UTruckAtWH::_internal_has_truck_id() const {
  bool value = (_has_bits_[0] & 0x00000001u) != 0;
  return value;
}
inline bool UTruckAtWH::has_truck_id() const {
  return _internal_has_truck_id();
}
inline void UTruckAtWH::clear_truck_id() {
  truck_id_ = int64_t{0};
  _has_bits_[0] &= ~0x00000001u;
}
inline int64_t UTruckAtWH::_internal_truck_id() const {
  return truck_id_;
}
inline int64_t UTruckAtWH::truck_id() const {
  // @@protoc_insertion_point(field_get:UTruckAtWH.truck_id)
  return _internal_truck_id();
}
inline void UTruckAtWH::_internal_set_truck_id(int64_t value) {
  _has_bits_[0] |= 0x00000001u;
  truck_id_ = value;
}
inline void UTruckAtWH::set_truck_id(int64_t value) {
  _internal_set_truck_id(value);
  // @@protoc_insertion_point(field_set:UTruckAtWH.truck_id)
}

// required int64 warehouse_id = 2;
inline bool UTruckAtWH::_internal_has_warehouse_id() const {
  bool value = (_has_bits_[0] & 0x00000002u) != 0;
  return value;
}
inline bool UTruckAtWH::has_warehouse_id() const {
  return _internal_has_warehouse_id();
}
inline void UTruckAtWH::clear_warehouse_id() {
  warehouse_id_ = int64_t{0};
  _has_bits_[0] &= ~0x00000002u;
}
inline int64_t UTruckAtWH::_internal_warehouse_id() const {
  return warehouse_id_;
}
inline int64_t UTruckAtWH::warehouse_id() const {
  // @@protoc_insertion_point(field_get:UTruckAtWH.warehouse_id)
  return _internal_warehouse_id();
}
inline void UTruckAtWH::_internal_set_warehouse_id(int64_t value) {
  _has_bits_[0] |= 0x00000002u;
  warehouse_id_ = value;
}
inline void UTruckAtWH::set_warehouse_id(int64_t value) {
  _internal_set_warehouse_id(value);
  // @@protoc_insertion_point(field_set:UTruckAtWH.warehouse_id)
}

// required int64 package_id = 3;
inline bool UTruckAtWH::_internal_has_package_id() const {
  bool value = (_has_bits_[0] & 0x00000004u) != 0;
  return value;
}
inline bool UTruckAtWH::has_package_id() const {
  return _internal_has_package_id();
}
inline void UTruckAtWH::clear_package_id() {
  package_id_ = int64_t{0};
  _has_bits_[0] &= ~0x00000004u;
}
inline int64_t UTruckAtWH::_internal_package_id() const {
  return package_id_;
}
inline int64_t UTruckAtWH::package_id() const {
  // @@protoc_insertion_point(field_get:UTruckAtWH.package_id)
  return _internal_package_id();
}
inline void UTruckAtWH::_internal_set_package_id(int64_t value) {
  _has_bits_[0] |= 0x00000004u;
  package_id_ = value;
}
inline void UTruckAtWH::set_package_id(int64_t value) {
  _internal_set_package_id(value);
  // @@protoc_insertion_point(field_set:UTruckAtWH.package_id)
}
...
// required int64 truck_id = 1;
inline bool ATruckLoaded::_internal_has_truck_id() const {
  bool value = (_has_bits_[0] & 0x00000001u) != 0;
  return value;
}
inline bool ATruckLoaded::has_truck_id() const {
  return _internal_has_truck_id();
}
inline void ATruckLoaded::clear_truck_id() {
  truck_id_ = int64_t{0};
  _has_bits_[0] &= ~0x00000001u;
}
inline int64_t ATruckLoaded::_internal_truck_id() const {
  return truck_id_;
}
inline int64_t ATruckLoaded::truck_id() const {
  // @@protoc_insertion_point(field_get:ATruckLoaded.truck_id)
  return _internal_truck_id();
}
inline void ATruckLoaded::_internal_set_truck_id(int64_t value) {
  _has_bits_[0] |= 0x00000001u;
  truck_id_ = value;
}
inline void ATruckLoaded::set_truck_id(int64_t value) {
  _internal_set_truck_id(value);
  // @@protoc_insertion_point(field_set:ATruckLoaded.truck_id)
}

// required int64 warehouse_id = 2;
inline bool ATruckLoaded::_internal_has_warehouse_id() const {
  bool value = (_has_bits_[0] & 0x00000002u) != 0;
  return value;
}
inline bool ATruckLoaded::has_warehouse_id() const {
  return _internal_has_warehouse_id();
}
inline void ATruckLoaded::clear_warehouse_id() {
  warehouse_id_ = int64_t{0};
  _has_bits_[0] &= ~0x00000002u;
}
inline int64_t ATruckLoaded::_internal_warehouse_id() const {
  return warehouse_id_;
}
inline int64_t ATruckLoaded::warehouse_id() const {
  // @@protoc_insertion_point(field_get:ATruckLoaded.warehouse_id)
  return _internal_warehouse_id();
}
inline void ATruckLoaded::_internal_set_warehouse_id(int64_t value) {
  _has_bits_[0] |= 0x00000002u;
  warehouse_id_ = value;
}
inline void ATruckLoaded::set_warehouse_id(int64_t value) {
  _internal_set_warehouse_id(value);
  // @@protoc_insertion_point(field_set:ATruckLoaded.warehouse_id)
}

// required int64 package_id = 3;
inline bool ATruckLoaded::_internal_has_package_id() const {
  bool value = (_has_bits_[0] & 0x00000004u) != 0;
  return value;
}
inline bool ATruckLoaded::has_package_id() const {
  return _internal_has_package_id();
}
inline void ATruckLoaded::clear_package_id() {
  package_id_ = int64_t{0};
  _has_bits_[0] &= ~0x00000004u;
}
inline int64_t ATruckLoaded::_internal_package_id() const {
  return package_id_;
}
inline int64_t ATruckLoaded::package_id() const {
  // @@protoc_insertion_point(field_get:ATruckLoaded.package_id)
  return _internal_package_id();
}
inline void ATruckLoaded::_internal_set_package_id(int64_t value) {
  _has_bits_[0] |= 0x00000004u;
  package_id_ = value;
}
inline void ATruckLoaded::set_package_id(int64_t value) {
  _internal_set_package_id(value);
  // @@protoc_insertion_point(field_set:ATruckLoaded.package_id)
}
...
// required int64 package_id = 3;
inline bool UPackageDelivered::_internal_has_package_id() const {
  bool value = (_has_bits_[0] & 0x00000001u) != 0;
  return value;
}
inline bool UPackageDelivered::has_package_id() const {
  return _internal_has_package_id();
}
inline void UPackageDelivered::clear_package_id() {
  package_id_ = int64_t{0};
  _has_bits_[0] &= ~0x00000001u;
}
inline int64_t UPackageDelivered::_internal_package_id() const {
  return package_id_;
}
inline int64_t UPackageDelivered::package_id() const {
  // @@protoc_insertion_point(field_get:UPackageDelivered.package_id)
  return _internal_package_id();
}
inline void UPackageDelivered::_internal_set_package_id(int64_t value) {
  _has_bits_[0] |= 0x00000001u;
  package_id_ = value;
}
inline void UPackageDelivered::set_package_id(int64_t value) {
  _internal_set_package_id(value);
  // @@protoc_insertion_point(field_set:UPackageDelivered.package_id)
}
...
// optional .UTruckAtWH truckAtWH = 1;
inline bool UMessage::_internal_has_truckatwh() const {
  bool value = (_has_bits_[0] & 0x00000001u) != 0;
  PROTOBUF_ASSUME(!value || truckatwh_ != nullptr);
  return value;
}
inline bool UMessage::has_truckatwh() const {
  return _internal_has_truckatwh();
}
inline void UMessage::clear_truckatwh() {
  if (truckatwh_ != nullptr) truckatwh_->Clear();
  _has_bits_[0] &= ~0x00000001u;
}
inline const ::UTruckAtWH& UMessage::_internal_truckatwh() const {
  const ::UTruckAtWH* p = truckatwh_;
  return p != nullptr ? *p : reinterpret_cast<const ::UTruckAtWH&>(
      ::_UTruckAtWH_default_instance_);
}
inline const ::UTruckAtWH& UMessage::truckatwh() const {
  // @@protoc_insertion_point(field_get:UMessage.truckAtWH)
  return _internal_truckatwh();
}
inline void UMessage::unsafe_arena_set_allocated_truckatwh(
    ::UTruckAtWH* truckatwh) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(truckatwh_);
  }
  truckatwh_ = truckatwh;
  if (truckatwh) {
    _has_bits_[0] |= 0x00000001u;
  } else {
    _has_bits_[0] &= ~0x00000001u;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:UMessage.truckAtWH)
}
inline ::UTruckAtWH* UMessage::release_truckatwh() {
  _has_bits_[0] &= ~0x00000001u;
  ::UTruckAtWH* temp = truckatwh_;
  truckatwh_ = nullptr;
...
inline ::UTruckAtWH* UMessage::unsafe_arena_release_truckatwh() {
  // @@protoc_insertion_point(field_release:UMessage.truckAtWH)
  _has_bits_[0] &= ~0x00000001u;
  ::UTruckAtWH* temp = truckatwh_;
  truckatwh_ = nullptr;
  return temp;
}
inline ::UTruckAtWH* UMessage::_internal_mutable_truckatwh() {
  _has_bits_[0] |= 0x00000001u;
  if (truckatwh_ == nullptr) {
    auto* p = CreateMaybeMessage<::UTruckAtWH>(GetArenaForAllocation());
    truckatwh_ = p;
  }
  return truckatwh_;
}
inline ::UTruckAtWH* UMessage::mutable_truckatwh() {
  ::UTruckAtWH* _msg = _internal_mutable_truckatwh();
  // @@protoc_insertion_point(field_mutable:UMessage.truckAtWH)
  return _msg;
}
inline void UMessage::set_allocated_truckatwh(::UTruckAtWH* truckatwh) {
  ...
  if (truckatwh) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalGetOwningArena(truckatwh);
    if (message_arena != submessage_arena) {
      truckatwh = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(
          message_arena, truckatwh, submessage_arena);
    }
    _has_bits_[0] |= 0x00000001u;
  } else {
    _has_bits_[0] &= ~0x00000001u;
  ...
  truckatwh_ = truckatwh;
  // @@protoc_insertion_point(field_set_allocated:UMessage.truckAtWH)
}

// optional .UPackageDelivered packageDelivered = 2;
inline bool UMessage::_internal_has_packagedelivered() const {
  bool value = (_has_bits_[0] & 0x00000002u) != 0;
  PROTOBUF_ASSUME(!value || packagedelivered_ != nullptr);
  return value;
}
inline bool UMessage::has_packagedelivered() const {
  return _internal_has_packagedelivered();
}
inline void UMessage::clear_packagedelivered() {
  if (packagedelivered_ != nullptr) packagedelivered_->Clear();
  _has_bits_[0] &= ~0x00000002u;
}
inline const ::UPackageDelivered& UMessage::_internal_packagedelivered() const {
  const ::UPackageDelivered* p = packagedelivered_;
  return p != nullptr ? *p : reinterpret_cast<const ::UPackageDelivered&>(
      ::_UPackageDelivered_default_instance_);
}
inline const ::UPackageDelivered& UMessage::packagedelivered() const {
  // @@protoc_insertion_point(field_get:UMessage.packageDelivered)
  return _internal_packagedelivered();
}
inline void UMessage::unsafe_arena_set_allocated_packagedelivered(
    ::UPackageDelivered* packagedelivered) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(packagedelivered_);
  }
  packagedelivered_ = packagedelivered;
  if (packagedelivered) {
    _has_bits_[0] |= 0x00000002u;
  } else {
    _has_bits_[0] &= ~0x00000002u;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:UMessage.packageDelivered)
}
inline ::UPackageDelivered* UMessage::release_packagedelivered() {
  _has_bits_[0] &= ~0x00000002u;
  ::UPackageDelivered* temp = packagedelivered_;
...
inline ::UPackageDelivered* UMessage::unsafe_arena_release_packagedelivered() {
  // @@protoc_insertion_point(field_release:UMessage.packageDelivered)
  _has_bits_[0] &= ~0x00000002u;
  ::UPackageDelivered* temp = packagedelivered_;
  packagedelivered_ = nullptr;
  return temp;
}
inline ::UPackageDelivered* UMessage::_internal_mutable_packagedelivered() {
  _has_bits_[0] |= 0x00000002u;
  if (packagedelivered_ == nullptr) {
    auto* p = CreateMaybeMessage<::UPackageDelivered>(GetArenaForAllocation());
    packagedelivered_ = p;
  }
  return packagedelivered_;
}
inline ::UPackageDelivered* UMessage::mutable_packagedelivered() {
  ::UPackageDelivered* _msg = _internal_mutable_packagedelivered();
  // @@protoc_insertion_point(field_mutable:UMessage.packageDelivered)
  return _msg;
}
inline void UMessage::set_allocated_packagedelivered(::UPackageDelivered* packagedelivered) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete packagedelivered_;
  }
  if (packagedelivered) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalGetOwningArena(packagedelivered);
    if (message_arena != submessage_arena) {
      packagedelivered = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(
          message_arena, packagedelivered, submessage_arena);
    }
    _has_bits_[0] |= 0x00000002u;
  } else {
    _has_bits_[0] &= ~0x00000002u;
  ...
  packagedelivered_ = packagedelivered;
  // @@protoc_insertion_point(field_set_allocated:UMessage.packageDelivered)
}
...
// optional .ASendTruck sendTruck = 1;
inline bool AMessage::_internal_has_sendtruck() const {
  bool value = (_has_bits_[0] & 0x00000001u) != 0;
  PROTOBUF_ASSUME(!value || sendtruck_ != nullptr);
  return value;
}
inline bool AMessage::has_sendtruck() const {
  return _internal_has_sendtruck();
}
inline void AMessage::clear_sendtruck() {
  if (sendtruck_ != nullptr) sendtruck_->Clear();
  _has_bits_[0] &= ~0x00000001u;
}
inline const ::ASendTruck& AMessage::_internal_sendtruck() const {
  const ::ASendTruck* p = sendtruck_;
  return p != nullptr ? *p : reinterpret_cast<const ::ASendTruck&>(
      ::_ASendTruck_default_instance_);
}
inline const ::ASendTruck& AMessage::sendtruck() const {
  // @@protoc_insertion_point(field_get:AMessage.sendTruck)
  return _internal_sendtruck();
}
inline void AMessage::unsafe_arena_set_allocated_sendtruck(
    ::ASendTruck* sendtruck) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(sendtruck_);
  }
  sendtruck_ = sendtruck;
  if (sendtruck) {
    _has_bits_[0] |= 0x00000001u;
  } else {
    _has_bits_[0] &= ~0x00000001u;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:AMessage.sendTruck)
}
inline ::ASendTruck* AMessage::release_sendtruck() {
  _has_bits_[0] &= ~0x00000001u;
  ::ASendTruck* temp = sendtruck_;
  sendtruck_ = nullptr;
#ifdef PROTOBUF_FORCE_COPY_IN_RELEASE
  auto* old =  reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(temp);
  temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
...
inline ::ASendTruck* AMessage::unsafe_arena_release_sendtruck() {
  // @@protoc_insertion_point(field_release:AMessage.sendTruck)
  _has_bits_[0] &= ~0x00000001u;
  ::ASendTruck* temp = sendtruck_;
  sendtruck_ = nullptr;
  return temp;
}
inline ::ASendTruck* AMessage::_internal_mutable_sendtruck() {
  _has_bits_[0] |= 0x00000001u;
  if (sendtruck_ == nullptr) {
    auto* p = CreateMaybeMessage<::ASendTruck>(GetArenaForAllocation());
    sendtruck_ = p;
  }
  return sendtruck_;
}
inline ::ASendTruck* AMessage::mutable_sendtruck() {
  ::ASendTruck* _msg = _internal_mutable_sendtruck();
  // @@protoc_insertion_point(field_mutable:AMessage.sendTruck)
  return _msg;
}
inline void AMessage::set_allocated_sendtruck(::ASendTruck* sendtruck) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete sendtruck_;
  }
  if (sendtruck) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalGetOwningArena(sendtruck);
    if (message_arena != submessage_arena) {
      sendtruck = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(
          message_arena, sendtruck, submessage_arena);
    }
    _has_bits_[0] |= 0x00000001u;
  } else {
    _has_bits_[0] &= ~0x00000001u;
  ...
  sendtruck_ = sendtruck;
  // @@protoc_insertion_point(field_set_allocated:AMessage.sendTruck)
}

// optional .ATruckLoaded truckLoaded = 2;
inline bool AMessage::_internal_has_truckloaded() const {
  bool value = (_has_bits_[0] & 0x00000002u) != 0;
  PROTOBUF_ASSUME(!value || truckloaded_ != nullptr);
  return value;
}
inline bool AMessage::has_truckloaded() const {
  return _internal_has_truckloaded();
}
inline void AMessage::clear_truckloaded() {
  if (truckloaded_ != nullptr) truckloaded_->Clear();
  _has_bits_[0] &= ~0x00000002u;
}
inline const ::ATruckLoaded& AMessage::_internal_truckloaded() const {
  const ::ATruckLoaded* p = truckloaded_;
  return p != nullptr ? *p : reinterpret_cast<const ::ATruckLoaded&>(
      ::_ATruckLoaded_default_instance_);
}
inline const ::ATruckLoaded& AMessage::truckloaded() const {
  // @@protoc_insertion_point(field_get:AMessage.truckLoaded)
  return _internal_truckloaded();
}
inline void AMessage::unsafe_arena_set_allocated_truckloaded(
    ::ATruckLoaded* truckloaded) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(truckloaded_);
  }
  truckloaded_ = truckloaded;
  if (truckloaded) {
    _has_bits_[0] |= 0x00000002u;
  } else {
    _has_bits_[0] &= ~0x00000002u;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:AMessage.truckLoaded)
}
inline ::ATruckLoaded* AMessage::release_truckloaded() {
  _has_bits_[0] &= ~0x00000002u;
  ::ATruckLoaded* temp = truckloaded_;
...
inline ::ATruckLoaded* AMessage::unsafe_arena_release_truckloaded() {
  // @@protoc_insertion_point(field_release:AMessage.truckLoaded)
  _has_bits_[0] &= ~0x00000002u;
  ::ATruckLoaded* temp = truckloaded_;
  truckloaded_ = nullptr;
  return temp;
}
inline ::ATruckLoaded* AMessage::_internal_mutable_truckloaded() {
  _has_bits_[0] |= 0x00000002u;
  if (truckloaded_ == nullptr) {
    auto* p = CreateMaybeMessage<::ATruckLoaded>(GetArenaForAllocation());
    truckloaded_ = p;
  }
  return truckloaded_;
}
inline ::ATruckLoaded* AMessage::mutable_truckloaded() {
  ::ATruckLoaded* _msg = _internal_mutable_truckloaded();
  // @@protoc_insertion_point(field_mutable:AMessage.truckLoaded)
  return _msg;
}
inline void AMessage::set_allocated_truckloaded(::ATruckLoaded* truckloaded) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete truckloaded_;
  }
  if (truckloaded) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalGetOwningArena(truckloaded);
    if (message_arena != submessage_arena) {
      truckloaded = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(
          message_arena, truckloaded, submessage_arena);
    }
    _has_bits_[0] |= 0x00000002u;
  } else {
    _has_bits_[0] &= ~0x00000002u;
  ...
  truckloaded_ = truckloaded;
  // @@protoc_insertion_point(field_set_allocated:AMessage.truckLoaded)
}
